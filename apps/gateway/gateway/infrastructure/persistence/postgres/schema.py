"""Schema metadata and test bootstrap helpers for gateway persistence."""
...
fints_product_registration_table = Table(
    ...
    Column("registration_id", Uuid(as_uuid=True), nullable=False),
    Column("encrypted_product_key", LargeBinary(), nullable=False),
