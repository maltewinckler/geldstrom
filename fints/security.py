...
For new code, use:
    from fints.infrastructure.fints.auth import (
...
# New code should import from fints.infrastructure.fints.auth
def __getattr__(name: str):
    ...
    if name in deprecated_names:
        ...
        warnings.warn(
            ...
            "StandaloneAuthenticationMechanism from fints.infrastructure.fints.auth instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from fints.infrastructure.fints.auth import standalone_mechanisms
