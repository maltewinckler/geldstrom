...
import geldstrom.formals
import geldstrom.segments.dialog
import geldstrom.segments.message
...
from geldstrom.formals import NumericField
from geldstrom.parser import FinTS3Parser, FinTS3Serializer
...
def test_serialize_2():
    ...
    import geldstrom.segments
    s = SegmentSequence([geldstrom.segments.message.HNHBK3(header=geldstrom.formals.SegmentHeader('HNHBK', 1, 3), message_size='000000000428', hbci_version=300,
                                                       ...
                                                       reference_message=geldstrom.formals.ReferenceMessage(dialog_id='430711670077=043999659571CN9D=',
                                                                                                        message_number=2)),
                         geldstrom.segments.message.HNVSK3(header=geldstrom.formals.SegmentHeader('HNVSK', 998, 3),
                                                       ...
                                                       security_datetime=geldstrom.formals.SecurityDateTime(date_time_type='1'),
                         ...
                         geldstrom.segments.message.HNVSD1(header=geldstrom.formals.SegmentHeader('HNVSD', 999, 1), data=SegmentSequence([geldstrom.segments.message.HNSHK4(
                             header=geldstrom.formals.SegmentHeader('HNSHK', 2, 4),
                             security_profile=geldstrom.formals.SecurityProfile(security_method='PIN', security_method_version=1), security_function='999',
                             security_reference='9166926', security_application_area='1', security_role='1',
                             security_identification_details=geldstrom.formals.SecurityIdentificationDetails(identified_role='2', cid=None,
                                                                                                         identifier='oIm3BlHv6mQBAADYgbPpp+kWrAQA'),
                             security_reference_number=1, security_datetime=geldstrom.formals.SecurityDateTime(date_time_type='1'),
                             hash_algorithm=geldstrom.formals.HashAlgorithm(usage_hash='1', hash_algorithm='999', algorithm_parameter_name='1'),
                             signature_algorithm=geldstrom.formals.SignatureAlgorithm(usage_signature='6', signature_algorithm='10', operation_mode='16'),
                             key_name=geldstrom.formals.KeyName(bank_identifier=geldstrom.formals.BankIdentifier(country_identifier='280', bank_code='15050500'),
                                                            user_id='hermes', key_type='S', key_number=0, key_version=0)), geldstrom.segments.dialog.HIRMG2(
                             header=geldstrom.formals.SegmentHeader('HIRMG', 3, 2),
                             responses=[geldstrom.formals.Response(code='0010', reference_element=None, text='Nachricht entgegengenommen.'),
                                        geldstrom.formals.Response(code='0100', reference_element=None, text='Dialog beendet.')]), geldstrom.segments.message.HNSHA2(
                             header=geldstrom.formals.SegmentHeader('HNSHA', 4, 2), security_reference='9166926')])),
                         geldstrom.segments.message.HNHBS1(header=geldstrom.formals.SegmentHeader('HNHBS', 5, 1), message_number=2)])
