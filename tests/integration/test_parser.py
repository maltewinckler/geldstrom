...
Run with: pytest tests/integration/test_parser_migration.py --run-integration -v

For maximum debugging output:
    pytest tests/integration/test_parser_migration.py --run-integration -v -s --tb=long
"""
