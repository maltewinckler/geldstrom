...
.. deprecated::
    ...
    Example migration:
        # Old (deprecated)
        from geldstrom.formals import Amount1, Balance2, KTI1
...
from geldstrom.fields import *
from geldstrom.types import *
from geldstrom.utils import RepresentableEnum, ShortReprMixin, doc_enum
