...
.. deprecated::
    ...
    Example migration:
        # Old (deprecated)
        from geldstrom.fields import DataElementField, DataElementGroupField
...
from geldstrom.types import Container, SegmentSequence, TypedField
from geldstrom.utils import (
